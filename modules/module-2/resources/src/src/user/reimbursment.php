...
<head>
    <title>AWS GOAT V2 - Reimbursment <?$_SESSION['username']?>!</title>
    <meta charset="UTF-8">
        ...
        <div class="reimbursmentwrapper">
            ...
            <div class="container" style="margin-left:-10px;">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#appliedreimbursments">Applied Reimbursments</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#applyreimbursment">Apply Reimbursment</a></li>
                </ul>
                                ...
                                <div class="table-responsive">
                                    <table class="table bg-white">
                                        ...
                                        <tbody class="tablebodyrows">
                                            <?php
                                            $queryrem = "select reimbursment_id, type, filed_on, amount, status, file   from `reimbursments` where id = (SELECT id from users where username = '{$_SESSION['username']}')   ORDER BY filed_on DESC LIMIT 7 ;";
