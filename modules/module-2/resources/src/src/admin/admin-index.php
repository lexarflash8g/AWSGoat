                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <div class="dropdown notify">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-bell fa-xl"></i></a>
                ...
                <div class="card-big-shadow">
                    <div class="card card-just-text" data-background="color" data-color="green" data-radius="none">
                        <div class="content">
                            ...
                            <p class="description">Announcing next gen payslip upload system, now managers can upload payslips right from the portal! </p>
                        </div>
                    </div> <!-- end card -->
                </div>
            </div>
