...
<head>
    <title>AWS GOAT V2 - Payslips <? echo $_SESSION['username'] ?>!</title>
    <meta charset="UTF-8">
        ...
        <div class="reimbursmentwrapper">
            ...
            <div class="container" style="margin-left:-10px;">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#viewpayslips">View Payslips</a></li>
                </ul>
                                        ...
                                        <div class="form-row align-items-center">
                                            <div class="col-auto my-1">
                                                ...
                                                <select class="custom-select mr-sm-4" id="remname" name="remname">
                                                    ...
                                                    <?php
                                                        $queryrem = "select id, username from `users` where organization_id = '{$_SESSION['organization_id']}' AND isadmin = 0;";
